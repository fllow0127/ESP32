...
#include "lvgl.h"
	...
	typedef struct
	{
		...
		lv_obj_t *ClockScr_MsgFlagImg;
	} lv_ui;

	extern unsigned char CLockScrLiveFlag;
	...
	LV_IMG_DECLARE(_Waiting_alpha_150x150);
	LV_IMG_DECLARE(_CSbg_alpha_240x240);
	LV_IMG_DECLARE(_MsgFlag_alpha_40x40);
