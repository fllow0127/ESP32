...
#include "esp_lcd_gc9a01.h" // gc9a01的头文件
...
#define LCD_MOSI 17 // lcd的sda引脚
#define LCD_MISO -1 // lcd的miso引脚

#define LCD_DC 15                                 // lcd的dc引脚
#define LCD_CS 14                                 // lcd的cs引脚
...
void gc9a01_init(void)
{
    ...
    esp_lcd_new_panel_gc9a01(io_handle, &panel__dev_config, &panel_handle);

    esp_lcd_panel_reset(panel_handle);                              // 重启gc9a01
